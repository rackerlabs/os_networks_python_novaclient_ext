...
def do_network(cs, args):
    ...
    Show a network
    """
    network = cs.os_networks_python_novaclient_ext.get(args.network_id)
...
def do_network_list(cs, args):
    ...
    List networks
    """
    networks = cs.os_networks_python_novaclient_ext.list()
...
def do_network_create(cs, args):
    ...
    Create a network
    """
    network = cs.os_networks_python_novaclient_ext.create(args.label,
                                                           args.cidr)
    utils.print_dict(network._info)
...
def do_network_delete(cs, args):
    ...
    Delete a network
    """
    cs.os_networks_python_novaclient_ext.delete(args.network_id)
